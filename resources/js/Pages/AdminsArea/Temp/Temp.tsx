...
//                 {/* Mobile Menu Icon */}
//                 <div className="w-full h-auto p-5 md:hidden z-50">
//                     <IoMenu
//                         className={`text-2xl cursor-pointer z-50 max-md:fixed`}                       
//                         onClick={() => setMenu(!menu)}
//                     />
//                 </div>

//                 {/* lms */}
//                 <div className={`fixed inset-0 z-10 bg-blue-950 text-white transition-transform duration-300 ${menu ? 'translate-x-0' : '-translate-x-full'} md:static md:translate-x-0 md:bg-transparent`}>
